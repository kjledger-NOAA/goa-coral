...
taxonomy <-read.delim(here("data", "20260325_GOAcoral_MiFish", "trimmed", "filtered", "outputs", "blastnresults"), header = FALSE, na.strings=c(""," ","NA"))
head(taxonomy)
...
taxon_df <- taxon_df %>%
  mutate(species = ifelse(species == "Gadus ogac", "Gadus macrocephalus", species),
         ...
         species = ifelse(species == "Nansenia sanrikuensis", "Nansenia candida", species),
...
```{r}
write.csv(uncollapsed_taxonomy, here("data", "mifish_tax_outputs", "uncollapsed_taxonomy.csv"))
write.csv(collapsed_taxonomy, here("data", "mifish_tax_outputs", "collapsed_taxonomy.csv"))
```
