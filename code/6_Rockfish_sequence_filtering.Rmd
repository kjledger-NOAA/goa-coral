...
```{r}
path <- "~/Documents/goa-coral/fastq/20260520_GOAcoral_rckfish/trimmed"
...
Remove sequences that are much longer or shorter than expected - rockfish should be 206bp
```{r}
#seqtab2 <- seqtab[,nchar(colnames(seqtab)) %in% c(164:185)]
```
...
```{r}
out_path <- file.path(here("data", "20260520_rkfish_outputs"))
